...
const textSizeBottomZero = useRef(new Animated.Value(0)).current;
const textSizeBottomOne = useRef(new Animated.Value(0)).current;
const textSizeBottomTwo = useRef(new Animated.Value(0)).current;
const textSizeBottomThree = useRef(new Animated.Value(0)).current;
const textSizeBottomFour = useRef(new Animated.Value(0)).current;
const textSizeBottomFive = useRef(new Animated.Value(0)).current;
const textSizeBottomSix  = useRef(new Animated.Value(0)).current;
const textSizeBottomSeven = useRef(new Animated.Value(0)).current;
const textSizeBottomEight = useRef(new Animated.Value(0)).current;
const textSizeBottomNine  = useRef(new Animated.Value(0)).current;
...
///наполнения нижнего бокса элементами
        ...
        rezultBox.push(<Pressable key={props.sortRandomElem[0]} style={[styles.reaultContainerBox]} onPressIn = {(event)=>coordsZeroFx(event.target)}>
         <Animated.Text key={props.sortRandomElem[0]} style={[styles.textBottomBox,{fontSize:textSizeBottomZero}]} >{coordsZero}</Animated.Text>
          </Pressable>)
      
        rezultBox.push(<Pressable key={props.sortRandomElem[1]} style={[styles.reaultContainerBox]} onPressIn = {(event)=>coordsOneFx(event.target)}>
         <Animated.Text key={props.sortRandomElem[1]} style={[styles.textBottomBox,{fontSize:textSizeBottomOne}]} >{coordsOne}</Animated.Text>
          </Pressable>)
      
        rezultBox.push(<Pressable key={props.sortRandomElem[2]} style={[styles.reaultContainerBox]} onPressIn = {(event)=>coordsTwoFx(event.target)}>
         <Animated.Text key={props.sortRandomElem[2]} style={[styles.textBottomBox,{fontSize:textSizeBottomTwo}]} >{coordsTwo}</Animated.Text>
          </Pressable>)
      
      if(props.sortRandomElem.length > 3){
        rezultBox.push(<Pressable key={props.sortRandomElem[3]} style={[styles.reaultContainerBox]} onPressIn = {(event)=>coordsThreeFx(event.target)}>
      ...
      if(props.sortRandomElem.length > 4){
        rezultBox.push(<Pressable key={props.sortRandomElem[4]} style={[styles.reaultContainerBox]} onPressIn = {(event)=>coordsFourFx(event.target)}>
         <Animated.Text key={props.sortRandomElem[4]} style={[styles.textBottomBox,{fontSize:textSizeBottomFour}]} >{coordsFour}</Animated.Text>
          </Pressable>)
      }
      if(props.sortRandomElem.length > 5){
        rezultBox.push(<Pressable key={props.sortRandomElem[5]} style={[styles.reaultContainerBox]} onPressIn = {(event)=>coordsFiveFx(event.target)}>
         <Animated.Text key={props.sortRandomElem[5]} style={[styles.textBottomBox,{fontSize:textSizeBottomFive}]} >{coordsFive}</Animated.Text>
          </Pressable>)
      }
      if(props.sortRandomElem.length > 6){
        rezultBox.push(<Pressable key={props.sortRandomElem[6]} style={[styles.reaultContainerBox]} onPressIn = {(event)=>coordsSixFx(event.target)}>
         <Animated.Text key={props.sortRandomElem[6]} style={[styles.textBottomBox,{fontSize:textSizeBottomSeven}]} >{coordsSix}</Animated.Text>
          </Pressable>)
      }
      if(props.sortRandomElem.length > 7){
        rezultBox.push(<Pressable key={props.sortRandomElem[7]} style={[styles.reaultContainerBox]} onPressIn = {(event)=>coordsSevenFx(event.target)}>
      ...
      if(props.sortRandomElem.length > 8){
        rezultBox.push(<Pressable key={props.sortRandomElem[8]} style={[styles.reaultContainerBox]} onPressIn = {(event)=>coordsEightFx(event.target)}>
      ...
      if(props.sortRandomElem.length > 9){
        rezultBox.push(<Pressable key={props.sortRandomElem[9]} style={[styles.reaultContainerBox]} onPressIn = {(event)=>coordsNineFx(event.target)}>
...
//проверка чтобы хлемент верхнего поля не заменял установленный элемент нижнего поля
    if(JSON.stringify(themeBackSizeZero) === '36' ||
        JSON.stringify(themeBackSizeOne) === '36' ||
          JSON.stringify(themeBackSizeTwo) === '36' ||
            JSON.stringify(themeBackSizeThree) === '36' ||
              JSON.stringify(themeBackSizeFour) === '36' ||
                JSON.stringify(themeBackSizeFive) === '36' ||
                  JSON.stringify(themeBackSizeSix) === '36' ||
                    JSON.stringify(themeBackSizeSeven) === '36'||
                      JSON.stringify(themeBackSizeEight) === '36' ||
                        JSON.stringify(themeBackSizeNine) === '36'){
      return;
    }
...
//Функции верхнего поля наполнения массива выбранными элементами пользователя и отображения на экране
  function ClickElemMassZero(e,p){
